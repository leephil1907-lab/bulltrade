...
const BOT_DEFS = [
  {
    ...
    minBalance: 500, risk: 'Low', title: 'Conservative Momentum Scout', style: 'Systematic',
  ...
  },
  {
    ...
    minBalance: 2500, risk: 'Medium', title: 'Gold & Commodity Swing Engine', style: 'Swing / Position',
  ...
  },
  {
    ...
    minBalance: 25000, risk: 'High', title: 'Aggressive Momentum Bull', style: 'Momentum',
...
function seedBots() {
  for (const b of BOT_DEFS) {
    ...
    state.copy_leaders.push({
      id: uid('cl_'), userId: u.id, status: 'active', bot: true, emoji: b.emoji,
