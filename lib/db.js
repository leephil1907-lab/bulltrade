...
const DEFAULTS = () => ({
  ...
  settings: {
    ...
    minDeposit: 50,
    minWithdraw: 20,
    supportEmail: 'support@blockchainbullhorn.com',
...
module.exports = { db, load, save, flush, find, filter, insert, update, remove, wallet, creditWallet, logAudit, UPLOAD_DIR, DB_FILE, DEFAULTS };
