...
function webpush() {
  ...
  // single-file esbuild bundle — kept in public/assets/js/ because that path is
  // provably deployed (all site assets serve from there); hosts may filter
  // vendor/ or node_modules/ dirs out of the deployment image
  try { return require('../public/assets/js/webpush.bundle.js'); } catch (e) { return null; }
}
