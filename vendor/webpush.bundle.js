...
var require_web_push_constants = __commonJS({
  "node_modules/web-push/src/web-push-constants.js"(exports2, module2) {
    "use strict";
    var WebPushConstants2 = {};
    WebPushConstants2.supportedContentEncodings = {
      AES_GCM: "aesgcm",
      AES_128_GCM: "aes128gcm"
    };
    WebPushConstants2.supportedUrgency = {
      VERY_LOW: "very-low",
      LOW: "low",
      NORMAL: "normal",
      HIGH: "high"
    };
    module2.exports = WebPushConstants2;
  }
});
...
var require_vapid_helper = __commonJS({
  "node_modules/web-push/src/vapid-helper.js"(exports2, module2) {
    ...
    var jws = require_jws();
    var { URL } = require("url");
    var WebPushConstants2 = require_web_push_constants();
...
var require_web_push_error = __commonJS({
  "node_modules/web-push/src/web-push-error.js"(exports2, module2) {
    "use strict";
    function WebPushError2(message, statusCode, headers, body, endpoint) {
    ...
    require("util").inherits(WebPushError2, Error);
    module2.exports = WebPushError2;
  }
});
...
var require_web_push_lib = __commonJS({
  "node_modules/web-push/src/web-push-lib.js"(exports2, module2) {
    ...
    var WebPushError2 = require_web_push_error();
    var vapidHelper2 = require_vapid_helper();
    var encryptionHelper2 = require_encryption_helper();
    var webPushConstants = require_web_push_constants();
    var urlBase64Helper = require_urlsafe_base64_helper();
    var DEFAULT_TTL = 2419200;
    var gcmAPIKey = "";
    var vapidDetails;
    function WebPushLib2() {
    }
    WebPushLib2.prototype.setGCMAPIKey = function(apiKey) {
      if (apiKey === null) {
        gcmAPIKey = null;
        return;
      }
    ...
    WebPushLib2.prototype.setVapidDetails = function(subject, publicKey, privateKey) {
    ...
    WebPushLib2.prototype.generateRequestDetails = function(subscription, payload, options) {
    ...
    WebPushLib2.prototype.sendNotification = function(subscription, payload, options) {
      let requestDetails;
      try {
